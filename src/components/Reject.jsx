  ...
  return (
    <div className="flex ml-[12%]">
      ...
      <div className="flex-grow bg-gray-100  p-6">
        <div className="w-full mx-auto px-6 py-6 h-auto mt-2 max-w-4xl bg-white rounded-xl shadow-md border border-gray-300">
          {/* Header */}
          ...
          <div className="flex items-start gap-6 mb-6">
            ...
            <ul>
              ...
              <li>
                Permission Request <span className="font-semibold text-green-600">Reject</span>
              </li>
            </ul>
          </div>
